      ...
      <div className="grid-2">
          ...
          <div className="panel stack-panel" style={{ marginBottom: 0 }}>
            ...
            <div className="panel" style={{marginBottom:0}}>
              {oportunidades?.length ? (
                <table className="table compact allow-overflow">
                  <thead>
                    <tr>
                      <th>Serviço</th>
                      <th className="col-red">Valor avulso</th>
                      <th className="col-green">No dia da sua cirurgia</th>
                      <th className="col-action">Ação Sugerida</th>
                    </tr>
                  </thead>
                  <tbody>
                    {oportunidades.map((o, i)=>(
                      <tr key={i}>
                        <td>
                          <span className="svc-name tooltip">
                            {o.nome}
                            {/* ícone "i" */}
                            <svg className="info-ico" width="14" height="14" viewBox="0 0 24 24" aria-hidden="true">
                            ...
                            {o.descricao && (
                              <span className="tooltip-panel">
                                <span className="tip-title">{o.nome}</span>
                                <span className="tip-text">{o.descricao}</span>
                              </span>
                            )}
                          </span>
                        </td>
                        ...
                        <td className="col-action">
                          <button className="btn-cta" onClick={() => contratarAgora(o)}>
                            Contratar agora
                          </button>
                        </td>
                      </tr>
        ...
        <div className="panel viewer-panel">
          <div className="viewer-inner">
            <Viewer selecionados={viewerRegions} autoRotate />
          </div>
        </div>
      </div>
